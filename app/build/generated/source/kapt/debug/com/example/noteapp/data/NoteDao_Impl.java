...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `Note` (`title`,`description`,`isDone`,`date`,`id`) VALUES (?,?,?,?,?)";
      }
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new Note(_tmpTitle,_tmpDescription,_tmpIsDone,_tmpDate,_tmpId);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Note(_tmpTitle,_tmpDescription,_tmpIsDone,_tmpDate,_tmpId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getLastInsertedNote(final Continuation<? super List<Note>> continuation) {
    final String _sql = "SELECT * FROM note ORDER BY title DESC LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
